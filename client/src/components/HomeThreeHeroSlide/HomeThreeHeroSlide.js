                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="tp-slider-three z-index">
                                ...
                                <Fade right>
                                    <h1 className="tp-slider-three-title">{slider ? slider.map((x) => <span>{x.attributes.text2}</span>) : 'Home'}
                                        <br />{slider ? slider.map((x) => <span>{x.attributes.text3}</span>) : 'Home'} <br />{slider ? slider.map((x) => <span>{x.attributes.text4}</span>) : 'Home'}</h1>
                                </Fade>
