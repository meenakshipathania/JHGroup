...
const ServicesDetailsFaq = () => {
  ...
  useEffect(() => {
     const request = axios.CancelToken.source();
        axios.get('http://165.227.11.15:1337/api/categories?populate=*')
           .then((res) => {
            ...
            <div className="col-xl-9 col-lg-8">
              <div className="tp-service-details">
               ...
               : 'hgfhgf'}
                ...
                <p className="mb-40">{text ? text.map((x) => <p>{x.attributes.para1}</p>) : 'Home'}</p>
               ...
               : 'hgfhgf'}
                  ...
                  <div className="col-xl-6">
                    <p className="mb-20">{text ? text.map((x) => <p>{x.attributes.para2}</p>) : 'Home'}</p>
