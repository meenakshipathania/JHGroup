...
const ServicesDetailsFaq = () => {
  ...
  useEffect(() => {
     const request = axios.CancelToken.source();
        axios.get('http://165.227.11.15:1337/api/service1s/6?populate[nested][populate]=*')
           .then((res) => {
            ...
            <div className="col-xl-9 col-lg-8">
              <div className="tp-service-details">
               ...
               : 'hgfhgf'}
                ...
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t5}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t6}</p>) : 'Home'}</p>
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t7}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t8}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t9}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t10}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t11}</p>) : 'Home'} </p>
                <p className="mb-35 d-flex"> <i > <CgCheckO /> </i> { text2['attributes'] ? text2['attributes']['nested'].map((x) => <p>{x.t12}</p>) : 'Home'} </p>
