...
const ServicesDetailsFaq = () => {
  ...
  useEffect(() => {
     const request = axios.CancelToken.source();
        axios.get('http://165.227.11.15:1337/api/remodels?populate=*')
           .then((res) => {
            ...
            <div className="col-xl-9 col-lg-8">
              <div className="tp-service-details">
               ...
               : 'hgfhgf'}
                ...
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t4}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t5}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t6}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t7}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t8}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t9}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t10}</p>) : 'Home'} </p>
                <p className="d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t11}</p>) : 'Home'} </p>
                <p className="mb-35 d-flex"> <i > <CgCheckO /> </i> {text2 ? text2.map((x) => <p>{x.attributes.t12}</p>) : 'Home'} </p>
