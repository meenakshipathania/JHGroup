                     ...
                     <div className="col-lg-6">
                        <div className="tp-progress-text tp-team-progress mb-30">
                           <div className="section-title-wrapper">
                              <h5 className="tp-section-subtitle section__sm__title common-yellow-shape mb-20 heading-color-black">Our work Experience</h5>
                              <h2 className="tp-section-title mb-25 heading-color-black">Find Standard Cleaning <br/>with Personal Touch</h2>
                           </div>
                              ...
                              <div className="tp-skill__wrapper mb-45">
                                 ...
                                 <div className="progress">
                                    <div className="progress-bar wow slideInLeft" data-wow-duration="1s" data-wow-delay="0.5s" role="progressbar"
                                       style={{
                                          width: '90%', visibility: 'visible', animationDuration: '1s',
