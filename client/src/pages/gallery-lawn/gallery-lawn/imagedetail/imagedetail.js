...
const ServicesDetailsFaq = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://165.227.11.15:1337/api/service1s/9?populate[allimages][populate]=*')
      .then((res) => {
      ...
      <section className='grey'>
        <div className="row">
          <div className='col-md-12'>
            <h1 className="heading1">ARLINGTON / MANSFIELD, TX - JH GROUP LAWN CARE PICTURE GALLERY</h1>
          </div>
        </div>
