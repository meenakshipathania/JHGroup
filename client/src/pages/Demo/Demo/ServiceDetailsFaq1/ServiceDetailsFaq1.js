...
const ServicesDetailsFaq = () => {
  ...
  useEffect(() => {
     const request = axios.CancelToken.source();
        axios.get('http://165.227.11.15:1337/api/service1s/4?populate[nested][populate]=*')
           .then((res) => {
            ...
            <div className="col-xl-9 col-lg-8">
              <div className="tp-service-details">
               ...
               : 'hgfhgf'}
                ...
                <h3 className="tp-service-details-subtitle mb-20">{text1 ? text1.map((x) => <span>{x.attributes.heading}</span>) : 'Home'}</h3>
                <p className="mb-35">{text1 ? text1.map((x) => <span>{x.attributes.tagline}</span>) : 'Home'}</p>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="tp-service-details-feature text-center bg-gray-light mb-40">
                      ...
                      <h4 className="tp-service-details-feature-title">
                        <Link to="/servicesDetails">{text1 ? text1.map((x) => <span>{x.attributes.text1}</span>) : 'Home'}</Link></h4>
                    </div>
                  </div>
                  <div className="col-xl-4 col-md-6">
                    <div className="tp-service-details-feature text-center bg-gray-light mb-40">
                      ...
                      <h4 className="tp-service-details-feature-title">
                        <Link to="/servicesDetails">{text1 ? text1.map((x) => <span>{x.attributes.text2}</span>) : 'Home'}</Link></h4>
                    </div>
                  </div>
                  <div className="col-xl-4 col-md-6">
                    <div className="tp-service-details-feature text-center bg-gray-light mb-40">
                      ...
                      <h4 className="tp-service-details-feature-title">
                        <Link to="/servicesDetails">{text1 ? text1.map((x) => <span>{x.attributes.text3}</span>) : 'Home'}</Link></h4>
                    </div>
                  </div>
                </div>
               ...
               : 'hgfhgf'}
                  ...
                  <div className="col-xl-6">
                    <p className="mb-20">{ text2['attributes']  ? text2['attributes']['nested'].map((x) => <p>{x.para2}</p>) : 'Home'}</p>
