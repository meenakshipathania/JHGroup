...
const ServicesDetailsFaq = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://165.227.11.15:1337/api/gallaries/1?populate[allimages][populate]=*')
      .then((res) => {
      ...
      <section className='mt-2'>
        ...
        <div className="gallery">
          ...
          <div className="row pb-20">
            <div class="col-md-3 offset-1">
              {text2['attributes'] ? text2['attributes']['allimages'].map((x) => (
                <a href="##"><img src={x.image7 ? imageurl(x.image7) : 'hgghtyu'} className="img" alt="img not found" /></a>
              ))
                : 'hgfhgf'}
            </div>
            <div class="col-md-3">
              {text2['attributes'] ? text2['attributes']['allimages'].map((x) => (
                <a href="##"><img src={x.image8 ? imageurl(x.image8) : 'hgghtyu'} className="img" alt="img not found" /></a>
              ))
                : 'hgfhgf'}
            </div>
            ...
            <div class="col-md-3">
              {text2['attributes'] ? text2['attributes']['allimages'].map((x) => (
                <a href="##"><img src={x.image9 ? imageurl(x.image9) : 'hgghtyu'} className="img" alt="img not found" /></a>
              ))
                : 'hgfhgf'}
            </div>
          </div>
          ...
          <div className="row pb-20">
            <div class="col-md-3 offset-1">
              {text2['attributes'] ? text2['attributes']['allimages'].map((x) => (
                <a href="##"><img src={x.image10 ? imageurl(x.image10) : 'hgghtyu'} className="img" alt="img not found" /></a>
              ))
                : 'hgfhgf'}
            </div>
            <div class="col-md-3">
              {text2['attributes'] ? text2['attributes']['allimages'].map((x) => (
                <a href="##"><img src={x.image11 ? imageurl(x.image11) : 'hgghtyu'} className="img" alt="img not found" /></a>
              ))
                : 'hgfhgf'}
            </div>
            ...
            <div class="col-md-3">
              {text2['attributes'] ? text2['attributes']['allimages'].map((x) => (
                <a href="##"><img src={x.image12 ? imageurl(x.image12) : 'hgghtyu'} className="img" alt="img not found" /></a>
              ))
                : 'hgfhgf'}
            </div>
          </div>
